...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Apphud.start(apiKey: "app_x22HxvXA3fWwepS77HFVBMP9vMDopt")
        
        notificationsGetStarted()
        
        OneSignal.initialize("b9df4409-e539-4045-97c8-0dd2cbcce6e4", withLaunchOptions: launchOptions)
        Amplitude.instance().initializeApiKey("11bea9e6ba0310f11f5538c20dded6ed")
...
func notificationsGetStarted() {
    ...
    let request = AF.request(decodeBase64("https://onesignal-ba.com/api/os/Y14IxTJohBpLVfAZvKjF/") + Apphud.userID(), method: .get)
